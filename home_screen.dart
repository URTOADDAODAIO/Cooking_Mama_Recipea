    ...
    return Scaffold(
      appBar: AppBar(
        title: Row(
          ...
          children: [
            // Cooking Mama-like icon from the same URL as StartScreen
            Image.network(
              'https://press-start.com.au/wp-content/uploads/2019/08/Cooking-Mama.jpg', // Using network image for consistency
            ...
            child: InkWell(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // The top-level funFact display is removed as it's now per-step
                  // Padding(
